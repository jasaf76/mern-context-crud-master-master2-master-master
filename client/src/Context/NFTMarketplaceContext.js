...
import { createNftRequest } from "../api/nfts";
...
export const useNfts = () => {
  ...
  if (!context) { throw new Error("useNfts must be used within a NFTMarketplaceProvider"); }
  return context;
}
export const NFTMarketplaceProvider = ({ children }) => {
  ...
  //     const res = await createNftsRequest(data);
